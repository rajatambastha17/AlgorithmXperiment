...
public class EmployeeOperations {
    public static void main(String[] args) {
        ...
        Employee e1 = new Employee(21, "Rajat", 2019);
        Employee e2 = new Employee(22, "Anushri", 2018);
        Employee e3 = new Employee(17, "Bubi Jain", 2017);
        ...
        Employee e10 = new Employee(28, "Gandu", 2020);
        ...
        List<Employee> newList = employees.stream().filter(employee -> (employee.getYearOfJoining() > 2012 && employee.getYearOfJoining() < 2018))
                .toList();
